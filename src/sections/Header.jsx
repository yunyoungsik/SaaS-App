  ...
  return (
    ...
    >
      <div className="container flex h-14 items-center max-lg:px-5">
        ...
        >
          <div className="max-lg:flex max-lg:flex-col max-lg:min-h-screen max-lg:p-6 max-lg:overflow-hidden sidebar-before max-md:px-4">
            <nav className="max-lg:realative max-lg:z-2 max-lg:my-auto">
